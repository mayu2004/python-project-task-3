...
img_rock = tk.PhotoImage(file="images/player_rock.png").subsample(3, 3)
img_paper = tk.PhotoImage(file="images/player_paper.png").subsample(3, 3)
img_scissors = tk.PhotoImage(file="images/player_scissor.png").subsample(3, 3)
com_rock = tk.PhotoImage(file="images/com_rock.png")
com_paper = tk.PhotoImage(file="images/com_paper.png")
com_scissors = tk.PhotoImage(file="images/com_scissor.png")
